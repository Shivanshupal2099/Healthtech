        ...
        <div style={{ minHeight: '100vh', display: 'flex', border: '2px solid #4d2626', justifyContent: 'center', alignItems: 'center' }}>
            <div style={{ border: '2px solid #060505', borderRadius: '10px', height: '500px', width: '300px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <form onSubmit={handleSubmit} style={{ width: '100%', padding: '0 20px', boxSizing: 'border-box' }}>
                    ...
                    <button type="submit" style={{ width: '100%', padding: '10px', marginTop: '20px', backgroundColor: '#000000', color: 'white', border: 'none', borderRadius: '4px', fontSize: '14px', fontWeight: 'bold', cursor: 'pointer' }}>Login</button>
                    <br /><br />
                    <hr />
                    <b>
                        <button type="submit" style={{ width: '100%', padding: '10px', marginTop: '20px', backgroundColor: '#000000', color: 'white', border: 'none', borderRadius: '4px', fontSize: '14px', fontWeight: 'bold', cursor: 'pointer' }}>Biometric Authentication</button></b>
                </form>
